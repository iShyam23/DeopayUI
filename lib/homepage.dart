import 'package:app/bottomNavigation.dart';
        ...
        children: [
          Positioned(
            ...
            child: Container(
              ...
              image:DecorationImage(image: AssetImage("image/sky.avif"),fit:BoxFit.fill)
            ),
              child:Column(
            ...
            crossAxisAlignment:CrossAxisAlignment.start,
              ...
              style:TextStyle(fontSize:21,fontWeight: FontWeight.bold,color:Colors.white),
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(30),
                      image: DecorationImage(image: AssetImage('image/shy.jpg'),fit: BoxFit.fill)
                    ),
                  )
                ],
              ),
              ...
              Column(
                children: [
                  Container(decoration: BoxDecoration(
                    ...
                    height: 70,
                    width: 70,
                    child: Icon(Icons.attach_money,color:Colors.brown,size:40),
                  ),
                  SizedBox(height:5,),
